                ...
                <div class="col-md-12 column">
                    <table class="table table-condensed table-bordered">
                        ...
                        <tr>
                            ...
                            <td><img height="100" width="100" src="${productInfo.productIcon}"></img></td>
                            ...
                            <td>
                                <#if productInfo.getProductStatusEnum().message == "在架">
                                    <a href="/sell/seller/product/off_sale?productId=${productInfo.productId}&retUrl=${retUrl}">在架</a>
                                <#else>
                                    <a href="/sell/seller/product/on_sale?productId=${productInfo.productId}&retUrl=${retUrl}">下架</a>
                                </#if>
                            </td>
                        </tr>
                        </#list>
